...
const Sidebar = () => {
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen ">
      {/* lg:w-1/2 */}
      <div className="max-w-[300px] ml-0 lg:min-h-screen ">
        {/*  w-full lg:w-[432px]   */}
        {/* TODO: medium ish */}
        {/* mx-auto lg:ml-0 */}

        {/* Title */}
        <h1 className="mt-5 text-white lg:mt-20 pb-11 lg:pb-0">
